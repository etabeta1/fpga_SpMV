...
HLS_SOURCES = ../../../../testcase.cpp ../../../../testbench.cpp ../../../../SpMV.cpp
...
$(ObjDir)/testcase.o: ../../../../testcase.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../testcase.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/testcase.d
...
$(ObjDir)/SpMV.o: ../../../../SpMV.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../SpMV.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/SpMV.d
