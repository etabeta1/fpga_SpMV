...
//------------------------Parameter----------------------
`define TV_IN_gmem2 "../tv/cdatafile/c.SpMV.autotvin_gmem2.dat"
`define TV_OUT_gmem2 "../tv/rtldatafile/rtl.SpMV.autotvout_gmem2.dat"
...
parameter gmem2_C_DATA_BITWIDTH = 32'd 16;
parameter gmem2_transaction_depth = 32'd 11;
parameter gmem2_mem_depth = 32'd 6;
...
reg [gmem2_DATA_BITWIDTH - 1 : 0] gmem2_mem_3 [0: gmem2_mem_depth - 1] = '{default : 'h0}; 
    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > gmem2_mem_depth) begin
                $display ("D:/Desktop/SpMV/hls_component/hls_component/hls/sim/verilog/AESL_axi_master_gmem2.v: Write request address %d exceed AXI master gmem2 array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, gmem2_mem_depth); 
                $finish;
            end
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > gmem2_mem_depth) begin
                $display ("D:/Desktop/SpMV/hls_component/hls_component/hls/sim/verilog/AESL_axi_master_gmem2.v: Read request address %d exceed AXI master gmem2 array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, gmem2_mem_depth); 
                $finish;
            end
...
initial begin : read_file_process 
  ...
  while (trans_depth != 64'h5a5aa5a50f0ff0f0)  begin
      ...
      for(i = 0; i < gmem2_transaction_depth; i = i + 1) begin 
          ...
          if (i%2 == 1) begin
              case(mem_page)
                  0 : gmem2_mem_0[i/2] = mem_tmp;
                  1 : gmem2_mem_1[i/2] = mem_tmp;
                  2 : gmem2_mem_2[i/2] = mem_tmp;
                  3 : gmem2_mem_3[i/2] = mem_tmp;
      ...
      case(mem_page)
          0 : gmem2_mem_0[gmem2_transaction_depth/2] = mem_tmp;
          1 : gmem2_mem_1[gmem2_transaction_depth/2] = mem_tmp;
          2 : gmem2_mem_2[gmem2_transaction_depth/2] = mem_tmp;
          3 : gmem2_mem_3[gmem2_transaction_depth/2] = mem_tmp;
          default: $display("The page_num of read file is not valid!");
      endcase
      ret = $fread(trans_depth,fp);
