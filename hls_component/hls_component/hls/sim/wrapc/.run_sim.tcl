...
# 
# ==============================================================
set ::env(PATH) "D:/Xilinx/Vitis_HLS/2024.1/win64/tools/fpo_v7_1;$::env(Path)"
set ::env(PATH) "D:/Xilinx/Vitis_HLS/2024.1/win64/tools/fft_v9_1;$::env(Path)"
set ::env(PATH) "D:/Xilinx/Vitis_HLS/2024.1/win64/tools/fir_v7_0;$::env(Path)"
set ::env(PATH) "D:/Xilinx/Vitis_HLS/2024.1/win64/tools/dds_v6_0;$::env(Path)"
set ::env(PATH) "D:/Xilinx/Vitis_HLS/2024.1/tps/mingw/10.0.0/win64.o/nt/bin;$::env(Path)"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "SpMV.autotvin.dat"
	set constFileTvOut       "SpMV.autotvout.dat"
	set constFileHdlTvIn     "SpMV.autohdltvin.dat"
	set constFileHdlTvOut    "SpMV.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
